package com.ahnstar.skeleton.base.aop;
...
protected final Logger logger = (Logger) LoggerFactory.getLogger(getClass());
	...
	@Pointcut("execution(* com.ahnstar.skeleton..*Controller.*(..))")
	public void controllerPointcut(){
		
	}
	
	@Pointcut("execution(* com.ahnstar.skeleton..*Service.*(..))")
	public void servicePointcut(){
		
	}
	
	@Pointcut("execution(* com.ahnstar.skeleton..*Dao.*(..))")
